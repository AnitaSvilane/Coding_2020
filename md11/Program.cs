...
namespace Day11_arraysAndLists
{
    class Program
    {
        ...
        static void PrintStudents(Students[] st)
        {
            if(st[0]==null)
            {
        ...
        static void EditStudent(Students[] st)
        {
            ...
            if (index - 1 > st.Length - 1 || index - 1 < 0 || st[index - 1] == null)
            {
        ...
        static void TaskStudents()
        {
            ...
            a[1] = new Students("Juris", "Abols", 3);*/
            ...
            //Informaciju par visiem studentiem izvadit
        }
